...
describe('Pair', () => {
  const USDC = new Token(ChainId.MAINNET, '0x3c499c542cEF5E3811e1192ce70d8cC03d5c3359', 18, 'USDC', 'USD Coin')
  const DAI = new Token(ChainId.MAINNET, '0x8f3Cf7ad23Cd3CaDbD9735AFf958023239c6A063', 18, 'DAI', 'DAI Stablecoin')
  ...
  describe('#getAddress', () => {
    it('returns the correct address', () => {
      expect(Pair.getAddress(USDC, DAI)).toEqual('0x70B118b9Bd6996638024Be5EbBaFBEEe7DDe702C') // rabbitcoinswap
    })
  })
